...
/* harmony import */ var ngx_watermark__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-watermark */ 6402);
...
AppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 90, vars: 26, consts: [[1, "navbar", "navbar-expand-md", "navbar-dark", "bg-dark", "shadow-sm"], ["href", "#", 1, "navbar-brand"], ["height", "32px", "src", "https://angular.io/assets/images/logos/angular/angular.svg", "width", "32px"], [1, "nav", "navbar-nav", "mr-auto"], [1, "nav", "navbar-nav"], [1, "nav-item", "align-items-center"], ["href", "https://github.com/MADCAZ/ngx-watermark/"], ["alt", "GitHub Stars", "src", "https://img.shields.io/github/stars/MADCAZ/ngx-watermark?label=Github&style=social"], ["role", "main", 1, "container", "mt-3"], [1, "jumbotron", "text-center", 3, "ngxWatermark"], [1, "container"], [1, "lead", "text-muted"], ["href", "#", 1, "btn", "btn-primary", "mr-2", "my-2"], ["href", "#", 1, "btn", "btn-secondary", "my-2"], [1, "mb-5"], [1, "card"], [1, "card-header", "bg-secondary", "text-white"], ["aria-hidden", "true", 1, "fa", "fa-cog"], [1, "card-body"], [1, "row"], [1, "form-group", "col"], ["for", "text"], ["id", "text", "rows", "3", 1, "form-control", 3, "ngModel", "ngModelOptions", "ngModelChange", "change"], [1, "col"], [1, "form-group", "col-md-6"], ["for", "font"], ["id", "font", 1, "form-control", 3, "ngModel", "ngModelOptions", "ngModelChange", "change"], ["value", "Arial"], ["value", "Georgia"], ["value", "Courier New"], ["value", "Kanit"], ["for", "fontSize"], ["id", "fontSize", 1, "form-control", 3, "ngModel", "ngModelOptions", "ngModelChange", "change"], ["value", "16px"], ["value", "20px"], ["value", "24px"], ["value", "28px"], ["value", "32px"], ["value", "40px"], ["triangle", "hide", "width", "350px", 3, "color", "onChange"], ["for", "alpha"], ["type", "range", "id", "alpha", "min", "0", "max", "1", "step", "0.1", 1, "custom-range", 3, "ngModel", "ngModelOptions", "ngModelChange"], ["for", "degree"], ["type", "range", "id", "degree", "min", "-90", "max", "90", "step", "5", 1, "custom-range", 3, "ngModel", "ngModelOptions", "ngModelChange"], ["for", "width"], ["type", "number", 1, "form-control", 3, "ngModel", "ngModelOptions", "ngModelChange", "change"], ["for", "height"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_textarea_ngModelChange_32_listener($event) { return ctx.optionsText = $event; })("change", function AppComponent_Template_textarea_change_32_listener() { return ctx.optionsTextChange(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_select_ngModelChange_39_listener($event) { return ctx.optionsFont = $event; })("change", function AppComponent_Template_select_change_39_listener() { return ctx.optionsFontChange(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_select_ngModelChange_51_listener($event) { return ctx.optionsFontSize = $event; })("change", function AppComponent_Template_select_change_51_listener() { return ctx.optionsFontSizeChange(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("onChange", function AppComponent_Template_color_twitter_onChange_67_listener($event) { return ctx.colorSelect($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_74_listener($event) { return ctx.optionsAlpha = $event; })("ngModelChange", function AppComponent_Template_input_ngModelChange_74_listener() { return ctx.optionsAlphaChange(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_80_listener($event) { return ctx.optionsDegree = $event; })("ngModelChange", function AppComponent_Template_input_ngModelChange_80_listener() { return ctx.optionsDegreeChange(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_85_listener($event) { return ctx.optionsWidth = $event; })("change", function AppComponent_Template_input_change_85_listener() { return ctx.optionsWidthChange(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_89_listener($event) { return ctx.optionsHeight = $event; })("change", function AppComponent_Template_input_change_89_listener() { return ctx.optionsHeightChange(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()()()()()()();
    } if (rf & 2) {
...
/* harmony import */ var ngx_watermark__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-watermark */ 6402);
...
AppModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__.BrowserModule,
        ...
        ngx_watermark__WEBPACK_IMPORTED_MODULE_5__.NgxWatermarkModule,
        ngx_color_twitter__WEBPACK_IMPORTED_MODULE_6__.ColorTwitterModule] });
...
/***/ 6402:
/*!*******************************************************!*\
  !*** ./dist/ngx-watermark/fesm2020/ngx-watermark.mjs ***!
  \*******************************************************/
...
NgxWatermarkDirective.ɵfac = function NgxWatermarkDirective_Factory(t) {
...
NgxWatermarkDirective.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
...
NgxWatermarkModule.ɵfac = function NgxWatermarkModule_Factory(t) {
  return new (t || NgxWatermarkModule)();
};

NgxWatermarkModule.ɵmod = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
  type: NgxWatermarkModule
});
NgxWatermarkModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({});
...
module.exports = JSON.parse('{"name":"ngx-watermark-base","version":"14.0.0","scripts":{"ng":"ng","start":"ng serve","build":"ng build","test":"ng test","lint":"ng lint","e2e":"ng e2e","build:deploy":"run-s version changelog build:lib build:demo update:readme","build:lib":"ng build ngx-watermark","build:demo":"ng build demo --base-href=https://madcaz.github.io/ngx-watermark/","update:readme":"cp -R ./README.md ./dist/ngx-watermark","version":"node scripts/version","changelog":"conventional-changelog -p angular -i CHANGELOG.md -s","demo:deploy":"ngh --dir=dist/demo","publish":"npm publish dist/ngx-watermark/","postinstall":"ngcc"},"private":true,"dependencies":{"@angular/animations":"^14.2.3","@angular/cdk":"^13.0.0","@angular/common":"^14.2.3","@angular/compiler":"^14.2.3","@angular/core":"^14.2.3","@angular/forms":"^14.2.3","@angular/material":"^13.0.0","@angular/platform-browser":"^14.2.3","@angular/platform-browser-dynamic":"^14.2.3","@angular/router":"^14.2.3","fontfaceobserver":"^2.3.0","ngx-color":"^7.3.3","rxjs":"~6.5.4","tslib":"^2.0.0","zone.js":"~0.11.4"},"devDependencies":{"@angular-devkit/build-angular":"^14.2.3","@angular/cli":"^14.2.3","@angular/compiler-cli":"^14.2.3","@angular/language-service":"^14.2.3","@types/jasmine":"~3.6.0","@types/jasminewd2":"~2.0.3","@types/node":"^12.12.36","codelyzer":"^6.0.0","execa":"^1.0.0","jasmine-core":"~3.6.0","jasmine-spec-reporter":"~5.0.0","karma":"~6.3.4","karma-chrome-launcher":"~3.1.0","karma-coverage-istanbul-reporter":"~3.0.2","karma-jasmine":"~4.0.0","karma-jasmine-html-reporter":"^1.5.0","ng-packagr":"^14.2.1","npm-run-all":"^4.1.5","protractor":"~7.0.0","ts-node":"~8.3.0","tslint":"~6.1.0","typescript":"~4.8.3"}}');
